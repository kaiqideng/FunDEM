...
const double* inverseMass_geo_p, 

const double* normalStiffness_mat_p, 
const double* shearStiffness_mat_p, 
const double* frictionCoefficient_mat_p, 
const double* restitutionCoefficient_mat_p, 
...
const size_t numPair)
{
	...
	const int idx_i = particleID_bNode_p[boundaryNodePointed[k]];
	const double3 r_i = position_p[idx_i];
	const double3 v_i = velocity_p[idx_i];
	const double3 w_i = angularVelocity_p[idx_i];
	const double invM_i = inverseMass_geo_p[geometryID_p[idx_i]];
	const int matID_i = materialID_p[idx_i];
    const double kn_i = normalStiffness_mat_p[matID_i];
	const double ks_i = shearStiffness_mat_p[matID_i];
	const double mu_i = frictionCoefficient_mat_p[matID_i];
	const double res_i = restitutionCoefficient_mat_p[matID_i];
	...
	const double invM_j = inverseMass_geo_p[geometryID_p[idx_j]];
	const int matID_j = materialID_p[idx_j];
	const double kn_j = normalStiffness_mat_p[matID_j];
	const double ks_j = shearStiffness_mat_p[matID_j];
	const double mu_j = frictionCoefficient_mat_p[matID_j];
	const double res_j = restitutionCoefficient_mat_p[matID_j];
...
const int* materialID_fp,

const double* frictionCoefficient_mat_fp, 
const double* restitutionCoefficient_mat_fp, 
...
const size_t numPair)
{
	...
	const int matID_j = materialID_fp[idx_j];
	const double mu_j = frictionCoefficient_mat_fp[matID_j];
	const double res_j = restitutionCoefficient_mat_fp[matID_j];
...
cudaStream_t stream)
{
    ...
    normalStiffness_mat_p,
    shearStiffness_mat_p,
    frictionCoefficient_mat_p,
	restitutionCoefficient_mat_p,
...
cudaStream_t stream)
{
	...
	frictionCoefficient_mat_fp,
	restitutionCoefficient_mat_fp,
