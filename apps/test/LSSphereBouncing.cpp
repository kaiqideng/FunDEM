...
int main(const int argc, char** argv)
{
    ...
    solver_.addParticleMaterial(normalStiffness, 0., 0., 1.0);
    solver_.addParticleGeometry(sphereMass,
    sphereInertia,
    sphereGridNodeLocalOrigin,
    sphereGridNodeSpacing,
    sphereGridNodeSize,
    sphereGridNodeSignedDistance,
    sphereBoundaryNodeLocalPosition,
    sphereBoundaryNodeConnectivity);
    solver_.addParticle(make_double3(0., 0., height),
    make_double3(0., 0., 0.),
    make_double3(0., 0., 0.),
    ...
    solver_.addWallMaterial(0., 1.0);
    solver_.addWallGeometry(planeGridNodeLocalOrigin, 
    planeGridNodeSpacing, 
    planeGridNodeSize, 
    planeGridNodeSignedDistance,
    planeBoundaryNodeLocalPosition,
    planeBoundaryNodeConnectivity);
    solver_.addWall(make_double3(0., 0., 0.), 
    make_double3(0., 0., 0.), 
    make_double3(0., 0., 0.), 
    make_quaternion(1., 0., 0., 0.), 
    0, 
